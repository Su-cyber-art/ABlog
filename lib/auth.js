...
function cookieOptions(maxAge) {
  return `Path=/; HttpOnly; SameSite=Lax${SITE_URL.startsWith('https://') ? '; Secure' : ''}; Max-Age=${maxAge}`;
}
...
module.exports = {
  hashPassword, verifyPassword, makeToken, checkToken, cookieOptions, parseCookies, SESSION_DAYS,
