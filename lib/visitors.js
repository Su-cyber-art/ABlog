...
function getVisitorKey(req, res) {
  ...
  appendCookie(res, `${VISITOR_COOKIE}=${token}; Path=/; HttpOnly; SameSite=Lax; Max-Age=${VISITOR_COOKIE_AGE}`);
...
purgeOldVisitors();
setInterval(purgeOldVisitors, 6 * 60 * 60 * 1000).unref();
...
module.exports = { trackVisitor, trackArticleVisitor, countryFlag, purgeOldVisitors, VISITOR_RETENTION_DAYS };
